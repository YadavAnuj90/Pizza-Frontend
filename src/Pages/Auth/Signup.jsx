...
function Signup() {
        return (
            <>
             ...
             <div className="relative mb-4">
             <label htmlFor="emailId" className="text-sm leading-7 text-gray-600">

             Email</label> <span className="text-red-600">*</span>
             ...
             <div className="relative mb-4">
             <label htmlFor="Mobile" className="text-sm leading-7 text-gray-600">

             Mobile Nunber</label> <span className="text-red-600">*</span>
             ...
             Password</label> <span className="text-red-600">*</span>
