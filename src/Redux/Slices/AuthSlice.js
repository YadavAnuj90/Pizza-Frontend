...
const initialState = {
  ...
  export const createAccount = createAsyncThunk('/auth/createAccount', async (data) => {
    ...
    try {
           ...
           toast.promise(response ,{
            ...
            loading:'Hold back tight,we are ergistering your id...',
  ...
  export const logout = createAsyncThunk('/auth/logout', async () => {
    ...
    console.log("Incomming data to the thunk");
    try {
...
const AuthSlice = createSlice({
    ...
    extraReducers: (builder) => {
      builder.addCase(login.fulfilled, (state, action) =>{
        //reducer which will exicute when the login thunk is fulfiled
      ...
      .addCase(logout.fulfilled, (state) => {
        //reducer which will exicute when the logout thunk is fullfilled
